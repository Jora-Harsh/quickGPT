...
const Credits = () => {
  ...
  return (
    <div className='max-w-7xl min-h-full  mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      <h2 className='text-3xl font-semibold text-center mb-10 xl:mt-24 text-gray-800 dark:text-white'>Credit Plans</h2>
