...
const SideBar = () => {
  ...
  return (
    ...
    <div className='flex flex-col h-screen min-w-72 p-5 dark:bg-gradient-to-b dark:from-[#242124]/90  dark:to-black border-r border-[#80609F]/30 backdrop-blur-3xl transition-all duration-500 max-md:absolute left-0 z-1'>
      {/* {Logo} */}
      ...
      <div className='flex items-center gap-2 p-3 mt-4 border border-gray-400 dark:border-white/20 rounded-md'>
        ...
        <input onChange={(e) => setSearch(e.target.value)} value={search} type="text" placeholder='Search conversations' className='text-xs placeholder:text-gray-400 outline-none bg-transparent dark:text-white text-black' />
      </div>
